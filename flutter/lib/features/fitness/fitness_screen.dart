...
class _FitnessScreenState extends ConsumerState<FitnessScreen>
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        '${_fmtMb(summary.totals.bytes)} stored in GCS',
                        style: TextStyle(fontSize: 12, color: t.textMuted),
                      ),
                    ),
                  ],
  ...
  Widget _healthLine(HdTokens t, FitnessSummary s) => Row(
    children: [
      Icon(
        s.allHealthy ? Icons.check_circle_outline : Icons.warning_amber_rounded,
        size: 16,
        color: s.allHealthy ? t.good : t.warning,
      ),
  ...
  Widget _pipelineCard(HdTokens t, FitnessSummary s) => _card(
    t,
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
